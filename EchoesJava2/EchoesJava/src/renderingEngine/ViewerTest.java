...
{    
    ...
    public void agentRemoved(agentId, current=None)
        pass
    public void agentPropertyChanged(agentId, propName, propValue, current=None)
        print "agentPropertyChanged", agentId, propName, propValue
    public void actionExecuted(agentId, action, objIds, current=None)
        pass
    public void userStarted(userName, current=None)
        pass
    public void scenarioStarted(name, current=None)
        print "scenarioStarted", name
    public void scenarioEnded(name, current=None)
        print "scenarioEnded", name
    public void userTouchedObject(name, current=None)
        pass
    public void userTouchedAgent(name, current=None)
        print "userTouchedAgent", name
        pass
    public void worldPropertyChanged(name, value, current=None)
        print "worldPropertyChanged", name, value
        pass    

public class FakeAgentPublisher()
    
    public void agentActionStarted(agent, action, details, current=None)
        print "agentActionStarted " + str(agent) + " " + str(action) + " " + str(details)
    public void agentActionCompleted(agent, action, details, current=None)
        print "agentActionCompleted " + str(agent) + " " + str(action) + " " + str(details)
    public void agentActionFailed(agent, action, details, reason, current=None)
        print "agentActionFailed " + str(agent) + " " + str(action) + " " + str(details) + " " + str(reason)
    
public class FakeIceCallback()
    public void ice_response(msg=None)
...
public void makeControlPanel(app)
