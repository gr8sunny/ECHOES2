 ...
 //   public classdocs
    ...
    {    
     //   overwriting the render method to draw the flower
        ...
        gl.glEnable( GL2.GL2.GL_TEXTURE_2D );
        gl.glTexParameterf(GL2.GL2.GL_TEXTURE_2D, GL2.GL2.GL_TEXTURE_MAG_FILTER, GL2.GL2.GL_NEAREST);
        gl.glTexParameterf(GL2.GL2.GL_TEXTURE_2D, GL2.GL2.GL_TEXTURE_MIN_FILTER, GL2.GL2.GL_NEAREST);
        gl.glBindTexture(GL2.GL2.GL_TEXTURE_2D, this.texture);
